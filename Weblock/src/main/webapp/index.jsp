...
<body>
		...
		<div class="container" data-aos="fade-up">
			...
			<div class="row justify-content-center" data-aos="fade-up"
				...
				<div class="col-xl-6 col-lg-8">
					<h1>
						Secure File Encryption and Decryption Made Simple<span>.</span>
					</h1>
					<h2>Your Trusted Online Tool</h2>
			...
			<div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in"
				...
				<div class="col-xl-2 col-md-4">
					<div class="icon-box">
						...
						<h3>
							<a href="AesUpload.jsp">Try WebLock</a>
						</h3>
					</div>
				</div>
				<div class="col-xl-2 col-md-4">
	...
	<main id="main">
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					...
					<div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content"
						style="text-align: justify;" data-aos="fade-right"
						data-aos-delay="100">
						<!-- <h3>Voluptatem dignissimos provident quasi corporis voluptates sit assumenda.</h3> -->
						<p class="fst-italic">
							<i class="ri-check-double-line"></i> Welcome to <B>WEB LOCK</B>,
							a product born from the collaboration of four dedicated
							individuals from SVVV College, Indore. As a major project
							undertaken in the final year of our studies, we aimed to address
							a critical need in today's digital landscape: the need for
							accessible, secure, and efficient file encryption and decryption.
						</p>
						<p>
							<i class="ri-check-double-line"></i> Our team comprises
							passionate students who share a common goal: to provide
							individuals and businesses with a user-friendly platform that
							puts data security back into their hands. Recognizing the
							challenges posed by data breaches and unauthorized access, we
							embarked on this journey to develop a robust solution that
							combines cutting-edge encryption technology with a simple and
							intuitive interface.
						</p>
						<!-- <ul>
              ...
              <li><i class="ri-check-double-line"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</li>
						...
						<p>
							<i class="ri-check-double-line"></i> As we introduce <b>WEB
								LOCK</b>, we extend our gratitude to SVVV College, Indore, for
							fostering an environment that encourages innovative thinking and
							empowers students to take on real-world challenges. This project
							wouldn't have been possible without the support of our mentors,
							peers, and the resources provided by our academic institution. <BR></BR>
							Join us on our journey to redefine the way individuals and
							businesses approach data security. With <B>WEB LOCK</B>, you're
							not just accessing a tool; you're joining a movement to make the
							digital world a safer place for everyone. <BR></BR> Thank you for
		...
		<section id="features" class="features">
			<div class="row justify-content-center" style="text-align: center;"
				...
				<div class="col-xl-6 col-lg-8">
					<h1>
						Features of Web<span>Lock.</span>
					</h1>
				...
				<div class="row">
					...
					<div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
						...
						<div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
							...
							<p>Enabled users to apply password protection to PDF files,
								adding an additional layer of security to sensitive documents</p>
						</div>
						<div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
							<i class="bx bx-images"></i>
							<h4>File Integrity Verification</h4>
							<p>Designed a feature to generate hash values and verify file
								integrity, ensuring data integrity and detecting unauthorized
								modifications.</p>
						</div>
						<div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
							<i class="bx bx-shield"></i>
							<h4>User-Friendly Interface</h4>
							<p>Created an intuitive interface facilitating seamless
								navigation, providing users with a comprehensive suite of
								cryptographic operations in a user-friendly manner.</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch"
						...
						<div class="icon-box">
							...
							<h4>
								<a href="DesUpload.jsp">DES Encryption & Decryption</a>
							</h4>
					...
					<div
						...
						<div class="icon-box">
							...
							<h4>
								<a href="CCUpload.jsp">Cipher Encryption & Decryption</a>
							</h4>
					...
					<div
						...
						<div class="icon-box">
							...
							<h4>
								<a href="AesUpload.jsp">AES Encryption & Decryption</a>
							</h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4"
						...
						<div class="icon-box">
							...
							<h4>
								<a href="Hash.jsp">Hash Funtions</a>
							</h4>
					...
					<div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4"
						...
						<div class="icon-box">
							...
							<h4>
								<a href="PdfPassword.jsp">Password Protected</a>
							</h4>
					...
					<div class="col-lg-3 col-md-6 d-flex align-items-stretch">
						<div class="member" data-aos="fade-up" data-aos-delay="100">
							<div class="member-img">
								<img src="assets/img/team/aman.png" class="img-fluid" alt="">
								<div class="social">
							...
							<div class="member-info">
								<h4>Aman Sisodiya</h4>
								<span>Chief BackEnd Developer</span>
							</div>
						</div>
					</div>
			...
			<div class="container" data-aos="fade-up">
				...
				<div>
					<iframe style="border: 0; width: 100%; height: 270px;"
						src="https://www.google.com/maps/embed?pb=!1m17!1m8!1m3!1d2490.979078588266!2d75.8481401928337!3d22.824463145585266!3m2!1i1024!2i768!4f13.1!4m6!3e0!4m0!4m3!3m2!1d22.8246213!2d75.8494668!5e0!3m2!1sen!2sin!4v1691485263543!5m2!1sen!2sin"
					...
					<div class="col-lg-4">
						<div class="info">
							<div class="address">
								...
								<h4>Location:</h4>
								<p>Shri Vaishnav Vidyapeeth Vishwavidyalaya, Campus : Indore
									, Ujjain Road, Indore€“ 453111</p>
							</div>

							<div class="email">
								<i class="bi bi-envelope"></i>
								<h4>Email:</h4>
								<p>webloack@example.com</p>
							</div>
	...
	<!-- ======= Footer ======= -->
	<jsp:include page="ExtraFiles/footer.jsp"></jsp:include>
	<!-- End Footer -->
